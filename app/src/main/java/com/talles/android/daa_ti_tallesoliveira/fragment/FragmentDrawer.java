...
import com.talles.android.daa_ti_tallesoliveira.adapter.NavigationDrawerAdapter;
...
public class FragmentDrawer extends Fragment {
    ...
    private static ArrayList<Integer> icons = null;
    ...
    public static List<NavDrawerItem> getData() {
        ...
        for (int i = 0; i < titles.length; i++) {
            ...
            switch (titles[i]){
                case "Atividades":
                    icons.add(new Integer(R.drawable.ic_tasks));
                    break;
                case "Adicionar Atividade":
                    icons.add(new Integer(R.drawable.ic_action_add));
                    break;
                case "Meus Pontos":
                    icons.add(new Integer(R.drawable.ic_plus_one));
                    break;
            }
        }
        return data;
